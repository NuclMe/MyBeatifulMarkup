...
function clickFunction(index, item) {
  let selectParent = item.parentElement
  ...
  document.body.addEventListener('click', addClickEventOnBody(e, selectParent), true)
  debugger
}
// close dropdown onclick on body
function addClickEventOnBody(e, selectParent) {
