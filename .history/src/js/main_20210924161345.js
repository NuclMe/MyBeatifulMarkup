...
document.querySelectorAll('.options__item').forEach((item, index) => {
  item.addEventListener('click', () => closeFunction(index))
})

function clickFunction(index) {
  let currentSelect = document.getElementsByClassName('select__header')[index]
  ...
  if (currentSelect.parentElement.classList.contains('is-active')) {
    ...
    addClickEventOnBody(currentSelect, selectItem)
  }
}

function closeFunction() {
  let selectItem = document.getElementsByClassName('.options__item')[index]
  let select = selectItem.closest('.select')
  select.classList.remove('is-active')
}

document.getElementsByTagName('body').occlick = function addClickEventOnBody(currentSelect, selectItem) {
  document.getElementsByTagName('body').occlick = addEventListener(
    'click',
    myFunc(),
