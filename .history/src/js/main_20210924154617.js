...
function addClickEventOnBody(currentSelect, selectItem) {
  document
    .querySelector('body')
    .addEventListener('click', (e) => myFunc(e, currentSelect, selectItem))
}

function myFunc(e, currentSelect, selectItem) {
