...
function clickFunction(index) {
  ...
  document.body.addEventListener('click', addClickEventOnBody(event, currentSelect), true)
}
function addClickEventOnBody(event, currentSelect) {
  debugger
  if (!event.target.matches('.select')) {
    currentSelect.parentElement.classList.replace('is-active', '')
  }
  // debugger
