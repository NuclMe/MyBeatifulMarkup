...
function clickFunction(index) {
  ...
  //     target.removeEventListener('click', clickFunction)
  //   } else {
  //   }
  // })
}
...
// function makeActiveDropdown() {
//   let selectHeader = console.log(selectHeader)
//   // debugger
//   selectHeader.addEventListener('click', function () {
//     if (selectHeader.parent.classList.contains('is-active')) {
//     }
//   })
// }
// makeActiveDropdown()
