...
function closeFunction(index, e) {
  ...
  let currentSelect = currentOption.parentElement.previousElementSibling.value
  let selectValue = currentOption.closest('.select').querySelector('.select__current').options[select.selectedIndex].value
