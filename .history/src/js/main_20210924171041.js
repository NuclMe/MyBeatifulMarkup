...
function clickFunction(index) {
  ...
  document.body.addEventListener('click', addClickEventOnBody(e), true)
}
function addClickEventOnBody(e) {
  let selectItem = document.getElementsByClassName()
  if (!e.target.matches('.select')) {
    selectItem.parentElement.classList.remove('is-active')
  }
  // debugger
