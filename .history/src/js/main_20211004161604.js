...
function closeFunction(index, e, option) {
  ...
  let optionSelect =
    option.parentElement.previousElementSibling.querySelector('.hidden-select__item')
  ...
  optionSelect.value = e.target.value
  let strUser = optionParent.options[optionParent.selectedIndex]
  debugger
